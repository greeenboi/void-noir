...
class SQLDetectiveGame {
  ...
  displayQueryError(error) {
    ...
    drawTransition(width, height) {
        ...
        const alpha = this.gameState.transitionDirection === 'out' 
        ...
        if (this.assets.detective) {
            ...
            if (isOverlapping) {
                ...
                const glow = this.ctx.createRadialGradient(
                    detectiveX + detectiveCollisionWidth/2, detectiveY + detectiveHeight/2, 0,
                    detectiveX + detectiveCollisionWidth/2, detectiveY + detectiveHeight/2, 120
                );
